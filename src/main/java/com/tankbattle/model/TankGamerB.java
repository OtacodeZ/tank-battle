...
public class TankGamerB extends Tank implements Collidable{
    ...
    public TankGamerB(int x, int y, double width, Image image, int speed) {
    ...
    public void update(long now,Set<KeyCode> keysPressed,int sceneWid,int sceneHei){
        Bullet.decideAndFireB(keysPressed,now,this,bullets);
    ...
    public void onCollide(Collidable other) {
        ...
        switch (other.getType()){
            ...
            case HEALTHPACK:this.HP.set(this.HP.get()+HealthPack.hp);break;
            case BOMB: this.HP.set(this.HP.get() - Bomb.hurt);
        }
    }
